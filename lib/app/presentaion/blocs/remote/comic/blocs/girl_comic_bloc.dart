...
class GirlComicBloc extends Bloc<ComicEvent, ComicState> {
  GetBoyOrGirlComicsUsecase usecase;
  GirlComicBloc(this.usecase) : super(ComicLoading()) {
  ...
  Future<FutureOr<void>> onGet(
    ...
    emit(ComicLoading());
    final dataState = await usecase.call(isBoy: false, page: event.page);
