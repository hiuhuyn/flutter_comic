...
class ItemNewComicPage extends StatefulWidget {
  const ItemNewComicPage({super.key});

  @override
  State<ItemNewComicPage> createState() => _ItemNewComicPageState();
}

class _ItemNewComicPageState extends State<ItemNewComicPage> {
